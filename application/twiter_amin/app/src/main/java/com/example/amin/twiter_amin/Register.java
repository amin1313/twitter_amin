...
public class Register
{
    ...
    public void set_lock(final String username, final String password, final Login.reult_callback send_lock)
    {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, s_params.URL_REGISTER,
